                ...
                <div class="left-col">
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập tên Product" name="name" />
                        </div>
                        <div class="form-group">
                ...
                <div class="right-col">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <div
                                id="quickAddCategoryBox"
                                style="display: none; margin-top: 10px; background: #f8f9fa; padding: 10px; border-radius: 4px; border: 1px dashed #ddd;"
                            >
                                <div style="display: flex; gap: 5px;">
                                    <input
                                        type="text"
                                        id="inputNewCategoryName"
                                    ...
                                    <button
                                        ...
                                        class="btn-save"
                                        style="padding: 0 10px; font-size: 12px; height: 32px;"
                                    >
                                        Lưu
                                    </button>
                                </div>
...
export async function createCustomer(params = {}) {
    ...
    container.innerHTML = ` 
        <div class="header-actions">
            ...
            <h2>${id ? `Chỉnh sửa: ${initialValues.name}` : "Thêm khách hàng"}</h2>
        </div>
